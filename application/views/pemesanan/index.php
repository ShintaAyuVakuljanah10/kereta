...
<table border="1" cellpadding="8">
    <tr>
        ...
        <th>total_harga</th>
        <th>status</th>
        <th>kode_tiket</th> <!-- Kolom baru kode_tiket -->
        <th>Aksi</th>
    </tr>
    <?php foreach($items as $i): ?>
    <tr>
        <td><?php echo $i->id_pemesanan; ?></td>
        <td><?php echo $i->id_tiket; ?></td>
        <td><?php echo $i->id_penumpang; ?></td>
        <td><?php echo $i->id_gerbong; ?></td>
        <td><?php echo $i->jml_penumpang; ?></td>
        <td><?php echo $i->total_harga; ?></td>
        <td><?php echo $i->status; ?></td>
        <td><?php echo $i->kode_tiket; ?></td>
        <td>
